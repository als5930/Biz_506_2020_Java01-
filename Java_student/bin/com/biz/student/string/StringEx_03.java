...
public class StringEx_03 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 단위(모듈) test라고한다
		 * score.csv파일을 읽어서 코드를 검증하고 모든 결과가 일치로 나타나는지 판단을 하는것
		 * 
		 * 이때 사용된 score.csv파일의 데이터를 testCase 라고 한다
		 */
		if(intSum == intKor+intEng+intMath) {
			System.out.println("계산결과일치!!");
